        ...
        <div className="container">
          ...
          <div className="beneficios-grid">
            <div className="beneficio-item">
              ...
              <p>Produtos de alta qualidade e hipoalergênicos</p>
            </div>
            <div className="beneficio-item">
            ...
            <div className="beneficio-item">
              <span className="emoji">📸</span>
              <p>Antes e depois registrados com carinho</p>
            </div>
            <div className="beneficio-item">
              <span className="emoji">🏠</span>
              <p>Ambiente limpo, climatizado e seguro</p>
            </div>
            <div className="beneficio-item">
              <span className="emoji">🫧</span>
              <p>Hidratação e finalização com perfume pet</p>
            </div>
            <div className="beneficio-item">
              <span className="emoji">🐾</span>
              <p>Atendimento individualizado e acolhedor</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="container">
          <div className="grid-galeria">
            {fotos.map((foto, index) => (
              <div className="item reveal" key={index}>
