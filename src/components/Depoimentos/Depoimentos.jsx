...
const Depoimentos = () => {
  const depoimentos = [
    ...
    {
      nome: "Naiane Caires",
      comentario: "Estive nessa clínica para levar minha coelha que estava com suspeita de sarna, e prontamente me atenderam com a maior educação e atenção com minha bebê! Dr. Rafael Carneiro com maior amor do mundo junto com a auxiliar dele, e após a consulta o Dr. Rafa manteve-se prontamente via WhatsApp para responder dúvidas e auxiliar nos cuidados com minha filha. Virou minha clínica de confiança para cuidar das minhas filhas atuais, e as que ainda virão rsrs. Parabéns a todos!❤️",
      estrelas: 5,
      foto: foto2,
    },
    {
      nome: "Érika Marques de Jesus",
      comentario: "Eu amei a dra Linda!! Eu estava passando com meu cachorro em outro local, pois ele estava tossindo demais.  O coitado não dormia e nem deixava a gente dormir.  Meses e meses e ele piorando, levei nesse local e quem o consultou foi a dra Linda.  Graças a Deus o Rico está muito melhor.  Eu só tenho a agradecer.",
      estrelas: 5,
      foto: foto3,
    },
    {
